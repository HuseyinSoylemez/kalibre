<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sertifika1.aspx.cs" Inherits="kalibre.Sertifika1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="form-group row">
                <div class="col-sm-5">
                    <img src="img/gazi-logo2.gif" class="mx-auto d-block img-fluid" width="100%" />
                </div>
                ...
                <div class="col-sm-2" style="/*width: 200px; height: 200px; border: solid 2px; */vertical-align: middle;">
                    ...
                    <table class="table table-bordered small">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <asp:Label ID="lbl_firma" runat="server" Text=""></asp:Label>GAZİ KAL.
                                </td>
                            </tr>
                            <tr>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12">
                    <p>
                       <b>Bu kalibrasyon sertifikası, Uluslararası Birimler Sisteminde (SI) tanımlanmış birimleri realize eden ulusal ölçüm standartlarına izlenebilirliği temsil eder.</b>
